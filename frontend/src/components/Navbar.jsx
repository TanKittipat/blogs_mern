const Navbar = () => {
  return (
    <header class="fixed top-0 z-50 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-md py-3">
      <nav class="max-w-[95vw] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        <div class="flex items-center justify-between">
          <a class="flex-none text-xl font-semibold focus:outline-none focus:opacity-80" href="/" aria-label="MernBlogs">
